...
In this lab, you will explore the Contoso traders application [https://contosotraders.com/](https://www.contosotraders.com/) and will go through the overview of app with focus on need for AI/Visual Search, use the image search option in the application to find the device from the product catalog and finally you will learn on the **Azure AI service** used in the application and also the high level idea of how the Cognitive services works.
